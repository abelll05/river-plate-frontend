...
const Historia = () => {
  return (
    <div className="historia-container">
      <h1 className="historia-title">Historia de River Plate</h1>
...
Además de conquistar, en el mismo año y en 1937, la Copa Aldao, organizada por la AFA y la AUF, sumando sus primeros dos títulos internacionales oficiales del profesionalismo. En 1937, ganó también la Copa Ibarguren, venciendo a Rosario Central por 5-0. De este modo, el club obtuvo los tres títulos oficiales disputados en la temporada 1937 y se configuró como un equipo copero en los primeros tiempos de la llamada «era rentada».
      ...
      <h2 className="historia-subtitle">La Máquina de River</h2>
      <p className="historia-text">
      La Maquina de River fué el fruto de un proceso de trabajo de inferiores iniciado en la década anterior, sumado a la continuidad de tener a exjugadores del club, con una visión compartida a cargo de la dirección técnica. Comenzó con Renato Cesarini a cargo de la dirección técnica y Carlos Peucelle en un doble rol, jugando sus últimos partidos y al mismo tiempo interviniendo en las inferiores.

Después de una campaña discreta en 1940, con la confirmación de Adolfo Pedernera como titular, se afianzó la delantera y el funcionamiento general que le daría fama mundial al equipo. ​ A partir de la segunda rueda consiguió un récord de partidos sin derrotas que lo llevó a consagrarse campeón en 1941 En su racha invicta el equipo obtendría esa misma temporada la Copa Ibarguren, la Copa Escobar y la Copa Aldao, obteniendo la cuádruple corona con todos los títulos oficiales nacionales e internacionales en juego.

La Maquina de River nació en 1942, luego de una victoria 6-2 contra Chacarita. Antes habían existido varios intentos de bautizar de esa manera a un equipo que se destacaba por su precisión de relojero, pero fue el periodista de El Gráfico Borocotó el que popularizó el apodo en la crónica del partido. “Jugó como una máquina el puntero” texto en el que comentaba el poderío ofensivo del vigente campeón.

En 1942, se produce el debut de Félix Loustau y se daría la delantera más recordada, compuesta por Juan Carlos Muñoz, José Manuel Moreno, Adolfo Pedernera, Ángel Labruna y el mismo Félix Loustau. También alternaba la titularidad en la delantera Aristóbulo Deambrossi por alguno de los punteros. El equipo obtendría el bicampeonato. También obtendría ese año la copa Ibarguren. Al año sufriría una baja sensible a mitad del campeonato, la partida de Moreno, considerado el mejor jugador del mundo en ese momento.

Si bien la leyenda de La maquina de River trascendió por sus atacantes, es un acto de justicia reconocer a cada uno de sus integrantes. En el 2-3-5 de Renato Cesarini el arquero era el peruano José Eusebio Soriano; Vaghi y Yácono; Rodolfi, Ramos y Ferreira; Muñoz, Moreno, Pedernera, Labruna y Loustau el quinteto de delanteros que hizo mítico a ese River.

En 1945 asume Peucelle, sucediendo a Cesarini en la conducción. River se convierte nuevamente en campeón, destacándose en gran forma Ángel Labruna, el volante central Néstor Rossi y teniendo como capitán al arquero peruano José Soriano. Ese mismo año vuelve a consagrarse en la Copa Aldao. En ese mismo año también debutarían, aunque con poca participación, Alfredo Di Stefano y Amadeo Carrizo. Entre 1941 y 1949 solo una sola vez River terminaría debajo del segundo puesto.

En 1947 se produce la partida definitiva de Pedernera después de sucesivas diferencias con la dirigencia. River, ya sin la Máquina, y con la dirección de otro exjugador José María Minella, se consagra nuevamente campeón con 48 puntos en 30 partidos. Al año siguiente River obtendría nuevamente la Copa Aldao por quinta oportunidad, luego emprendería una breve gira por Brasil donde derrota al campeón paulista Palmeiras y finalmente participaría del primer Campeonato Sudamericano de Clubes Campeones, saliendo segundo a un punto de Vasco da Gama.
...
Todos los integrantes de la Maquina de River triunfaron y se convirtieron en glorias del club. Sin embargo sus éxitos fueron más individuales que colectivos. Paradójicamente, en ese equipo que nada lo hacía sin el apoyo de todas sus partes, Muñoz, Moreno, Pedernera, Labruna y Loustau apenas compartieron la cancha en un puñado de partidos; pero se transformaron en leyendas.

La grandeza de La Maquina de River, no obstante, no se encuentra en una multiplicidad de títulos. Aunque River fue campeón en 1941, 1942 y 1945, en su época no logró el mayor de los reconocimientos. Jamás fue record de recaudación, y muchas veces ni siquiera llenaba la cancha. El público, tal vez, no supo interpretar el potencial de ese equipo que rara vez se vio eclipsado por el juego rival.
